...
import { HashMap, BUSSINESS_LOGIC_INJECTION_TOKEN, DATA_PROVIDER_INJECTION_TOKEN, IGenericCrudDataProvider, UserCharacters, StoryModel, CharacterStory } from '@text-adventures/shared';
...
export class CharacterStoryService implements CharacterStory {
  ...
  constructor(
    ...
    this.userCharactersService.getSelectedCharacter().pipe(
      ...
      this.storiesForSelectedCharacter$.next(v);
    });
